...
- **Bank and Cards** — card number is your username. pin protects you.
- **Jobs and Clock** — apply, get hired, show up for shifts. Miss too many, you're fired.
- **Crime and Records** — theft, hacking, fraud. Get caught, it follows you forever.
- **Jail** — served in in game time. bank freezes, job at risk.
- **Lottery** — weekly scratch tickets and a live drawing.
